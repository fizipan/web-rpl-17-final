...
@section('title', 'Dashboard Admin | RPL 17')
...
@section('content')
    ...
    <div id="page-content-wrapper">
        ...
        >
        <div class="container-fluid">
            @if ($ebook->count() || $project->count() || $tutorial->count())
                ...
                <div class="dashboard-content">
                    <div class="row">
                        ...
                        <div class="card mb-2">
                            <div class="card-body">
                            <div class="dashboard-card-title">E-Books</div>
                            <div class="dashboard-card-subtitle">{{ number_format($ebooks) }} Books</div>
                            </div>
                        </div>
                        </div>
                        <div class="col-md-4">
                        <div class="card mb-2">
                            ...
                            <div class="dashboard-card-subtitle">{{ number_format($tutorials) }}  Videos</div>
                            </div>
                        </div>
                        </div>
                        <div class="col-md-4">
                        <div class="card mb-2">
                            ...
                            <div class="dashboard-card-subtitle">{{ number_format($projects) }} Projects</div>
                            </div>
                        </div>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-12 mt-2">
                            ...
                            @foreach ($ebook as $item)
                                <a
                                    href="{{ route('ebook.edit', $item->slug) }}"
                            ...
                            @foreach ($project as $item)
                                <a
                                    href="{{ route('project.edit', $item->slug) }}"
                                    class="card card-list d-block"
                                >
                                    <div class="card-body">
                                        <div class="row">
