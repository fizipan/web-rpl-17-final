        ...
        <div class="section-content section-dashboard-home" data-aos="fade-up">
            <div class="container-fluid">
                @if (session()->has('success'))
                    <div class="flash-data-project" data-flashdata="{{ session()->get('success') }}"></div>
                @endif
                <div class="dashboard-heading">
                    <h2 class="dashboard-title">Projects</h2>
                    <p class="dashboard-subtitle">Give additional knowledge with the project</p>
                        ...
                        <div class="row mt-4">
                            @foreach ($projects as $project)
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                    <a href="{{ route('projects.edit', $project->slug) }}" class="card card-list-product mb-5">
                                    <div class="card-body">
                                        <img src="{{ Storage::url($project->photo) }}" alt="" class="w-100" style="height: 160px;">
                                        <div class="dashboard-product-title overflow">
                                            {{ Str::limit($project->name, 16) }}
                                        </div>
                                        <div class="dashboard-product-subtitle">
                                            {{ Str::limit($project->user->name, 16) }}
                                        </div>
                                    </div>
                                    </a>
                                </div>
                    ...
                    <div class="row mt-5 pt-3 text-center align-items-center justify-content-center">
                        <div class="col-lg-6">
                            ...
                            <div class="dashboard-product-subtitle text-center">
                                Make projects for the various knowledge
                            <br>
