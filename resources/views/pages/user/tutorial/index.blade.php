                ...
                <ul class="navbar-nav d-none d-lg-flex ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="{{ route('accounts.index') }}" class="dropdown-item">Settings</a>
        ...
        <div class="section-content section-dashboard-home" data-aos="fade-up">
            <div class="container-fluid">
                @if (session()->has('success'))
                    <div class="flash-data-tutorial" data-flashdata="{{ session()->get('success') }}"></div>
                @endif
                <div class="dashboard-heading">
                    <h2 class="dashboard-title">Tutorials</h2>
                    <p class="dashboard-subtitle">Give additional knowledge with the tutorial</p>
                    <a href="{{ route('tutorials.create') }}" class="btn btn-success">
                    Add New Tutorial
                    </a>
                </div>
                @if ($tutorials->count())
                        ...
                        <div class="row mt-4">
                            @foreach ($tutorials as $tutorial)
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                    <a href="{{ route('tutorials.edit', $tutorial->slug) }}" class="card card-list-product mb-5">
                                    <div class="card-body">
                                        <img src="{{ Storage::url($tutorial->photo) }}" alt="" class="w-100" style="height: 160px;">
                                        <div class="dashboard-product-title overflow">
                                            {{ Str::limit($tutorial->name, 16) }}
                                        </div>
                                        <div class="dashboard-product-subtitle">
                                            {{ Str::limit($tutorial->user->name, 16) }}
                                        </div>
                                    </div>
                                    </a>
                                </div>
